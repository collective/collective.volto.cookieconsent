# -*- coding: utf-8 -*-
"""Installer for the collective.volto.cookieconsent package."""
...
setup(
    ...
    version='1.1.2.dev0',
    description="Add-on for Volto to manage cookieconsent banners",
    ...
    url='https://github.com/collective/collective.volto.cookieconsent',
    project_urls={
    ...
    target = plone
    [console_scripts]
    update_locale = collective.volto.cookieconsent.locales.update:update_locale
    """,
)
